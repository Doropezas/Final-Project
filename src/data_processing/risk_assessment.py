...
class RiskAssessor:
    ...
    def _load_fx_volatility(self):
        ...
        return pd.read_csv(DATA_PATH / "processed/fx_volatility.csv")
    ...
    def calculate_scores(self):
        ...
        combined['fx_score'] = 100 - scaler.fit_transform(combined[['fx_30d_vol']])
        combined['current_account_score'] = scaler.fit_transform(combined[['current_account']])
        combined['sentiment_score'] = scaler.fit_transform(combined[['sentiment']])
        ...
        return combined.sort_values('risk_score', ascending=False)[[
            ...
            'debt_score', 'fx_score', 'current_account_score', 'sentiment_score'
        ]]